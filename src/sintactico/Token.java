				...
				if(pos>1){
					...
					if(sub.equals("fr")||sub.equals("fR")||sub.equals("Fr")||sub.equals("FR")||
						...
						if(pos == 2){
							...
							tok.verificar();
							tok = new Token(x, y+pos-2,cadena.substring(pos-2, cadena.length()) , true, 0,true,"string");
							tok.verificar();
						}
						...
						tok.verificar();
						tok = new Token(x, y+pos-1,cadena.substring(pos-1, cadena.length()) , true, 0,true,"string");
						tok.verificar();
						...
						tok.verificar();
						tok = new Token(x, y+pos,cadena.substring(pos, cadena.length()) , true, 0,true,"string");
						tok.verificar();
					}
				}else if(pos>0){
					if("ruRUfF".contains(""+cadena.charAt(0))){
						...
						Token tok = new Token(x, y, cadena.substring(0,pos-1), true, 0);
						tok.verificar();
						tok = new Token(x, y+1,cadena.substring(pos, cadena.length()) , true, 0,true,"string");
						tok.verificar();
					}
				}else{
					ver = true;
